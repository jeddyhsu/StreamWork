...
function ShowEditBox(profilePicture, commentId) {
    ...
    var edit = `<div class="d-flex flex-row">
                    <div id="comment-save-${commentId}" class="comment-send-reply-textarea form-custom-textarea ml-2 mb-1 comment-text" onkeydown="ButtonEnabledDisabled('save', '${commentId}');" onkeyup="ButtonEnabledDisabled('save', '${commentId}')" contenteditable="true" onmousedown="$('#comment-save-${commentId}').focus()">${message}</div>
...
function OpenInvalidComment(parentId) {
    ...
    var confirmation = ` <div class="custom-modal-content" style="width:300px; height:200px" >
                            ...
                            <h5 id="notification-message" class="form-header text-center pl-3 pr-3" style="padding-top:50px; font-size:16px;">Invalid Comment</h5>
