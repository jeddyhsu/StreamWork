...
namespace StreamWork.Services
{
    public class ScheduleService : StorageService
    {
        ...
        public async Task<List<ScheduledStream>> SaveToSchedule(HttpRequest request, string user)
        {
            try
            {
                //Schedule schedule = null;
                //var userProfile = await Get<Profiles>(SQLQueries.GetUserWithUsername, new string[] { user });
        ...
        public async Task<List<ScheduledStream>> GetSchedule(Profile profile)
        {
        ...
        public async Task<List<ScheduledStream>> DeleteFromSchedule(string id, Profile profile)
        {
